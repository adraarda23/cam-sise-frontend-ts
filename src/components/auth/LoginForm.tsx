      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-2xl">
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-lg block w-full px-3 py-3 border border-gray-300 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition duration-150"
        ...
        <div className="text-center text-xs text-gray-500 bg-gray-50 p-4 rounded-lg">
          ...
          <div className="space-y-1">
            ...
            <p><span className="font-medium">Customer:</span> customer / customer123</p>
          </div>
        </div>
      </div>
    </div>
